...
public class MediumEngine extends Engine {
	...
	/**
	 * Use this constructor to assign a variable of type motor connected to a
	 * particular port.
	 * 
	...
	public MediumEngine(Port port) {
		super(port, null, EV3SensorConstants.TYPE_NEWTACHO, MOVE_P, MOVE_I, MOVE_D, HOLD_P, HOLD_I, HOLD_D, OFFSET,
				MAX_SPEED);
	}
}
